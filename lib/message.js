...
const AbstractMessage = ((name) => {
    ...
    global[name] = AbstractMessage;

    return AbstractMessage;
})('_riff_AbstractMessage');
...
class Message extends AbstractMessage {
    ...
    constructor(headers, payload) {
        ...
        if (headers instanceof Message) {
            ...
            const message = Message.fromRiffMessage(headers.toRiffMessage({ preservePayload: true }));
            return message;
        } else {
